...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO t_sorties (code, nom, quantite, prix_unitaire, prix_total, date_sortie, date_expiration) 
                           VALUES (:code, :nom, :quantite, :prix_unitaire, :prix_total, :date_sortie, :date_expiration)");
